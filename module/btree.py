class BTreeNode:
    ...
    def from_dict(cls, node_dict):
        ...
        node = cls(leaf=node_dict['leaf'])
        node.keys = node_dict['keys']
        node.values = node_dict['values']
        node.children = [cls.from_dict(child) if child else None for child in node_dict['children']]
        return node
...
class BTree:
    ...
    def load_from_file(cls, filename):
        ...
        btree = cls(t=tree_data['t'])
        btree.root = BTreeNode.from_dict(tree_data['root'])
        return btree 